...
class DE implements LangInterface
{
    ...
    Sql Schema: %s, V %s<br/>',
        ...
        => 'Conf.php wurde erfolgreich erstellt. Die Verbindung zur Datenbank wurde hergestellt und das Startschema wurde installiert. Sie sind mit dem angegebenen Login als Creator eingeloggt. Klicken Sie auf den Link oder aktualisieren Sie die Seite.',
